...
`
  ...
  return (
    ...
    <div className="w-full max-w-4xl mx-auto p-6">
      <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl border border-white/20 p-8 flex flex-col justify-center items-center">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent mb-3">
            AI Quiz Generator
          </h1>
          <p className="text-gray-600 text-lg">Create engaging quizzes in seconds with AI</p>
        </div>
        ...
        <div className="w-full space-y-6">
          <div>
            ...
            <textarea
              className="w-full p-4 border-2 border-gray-200 rounded-2xl resize-none focus:border-blue-400 focus:outline-none focus:ring-4 focus:ring-blue-100 transition-all duration-300 text-gray-800 placeholder-gray-400 bg-white/50 backdrop-blur-sm"
              rows={5}
              value={prompt}
          ...
          <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl p-6">
            <div className="flex items-center gap-2 mb-4">
              ...
              <p className="font-semibold text-gray-700">Add sources (optional)</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white transition-all duration-200"
                >
                  {range.map((num) => (
    ...
    : ""
        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 p-6">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-8">
              <h1 className="text-3xl font-bold text-gray-800 mb-2">Your Generated Quiz</h1>
              <p className="text-gray-600">Review your questions below</p>
            </div>
            <div>
              {(() => {
                try {
        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 p-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-6">
              <div className="flex justify-between items-center mb-3">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-gradient-to-r from-red-500 to-pink-500 text-white rounded-xl hover:from-red-600 hover:to-pink-600 transition-all duration-300 font-medium shadow-lg hover:shadow-xl transform hover:scale-105"
                >
                  Start New Quiz
                </button>
              </div>
            ...
            <div className="sticky bottom-4 flex justify-center gap-4 bg-white/80 backdrop-blur-sm p-4 rounded-2xl shadow-lg border border-white/20 mt-6">
              <button
                onClick={() => setCurrentQuestionIndex(Math.max(0, currentQuestionIndex - 1))}
                disabled={currentQuestionIndex === 0}
                className="px-6 py-3 bg-white/80 backdrop-blur-sm text-gray-700 rounded-xl disabled:opacity-50 disabled:cursor-not-allowed hover:bg-gray-100 transition-all duration-300 font-medium shadow-lg hover:shadow-xl transform hover:scale-105 disabled:transform-none border border-gray-200"
              >
                ← Previous
              </button>
              ...
              <button
                ...
                className="px-6 py-3 bg-gradient-to-r from-blue-500 to-purple-500 text-white rounded-xl disabled:opacity-50 disabled:cursor-not-allowed hover:from-blue-600 hover:to-purple-600 transition-all duration-300 font-medium shadow-lg hover:shadow-xl transform hover:scale-105 disabled:transform-none"
              >
      ...
      <div className="flex flex-col justify-center items-center mt-20 space-y-6">
        <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-8 max-w-md w-full mx-4">
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              <label htmlFor="quiz-header" className="text-sm font-medium text-foreground">
                Quiz Header
              </label>
              <input 
                id="quiz-header"
